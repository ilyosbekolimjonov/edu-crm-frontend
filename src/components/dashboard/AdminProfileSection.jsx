...
export default function AdminProfileSection({ profile, onSubmit, submitting }) {
    ...
    return (
        <Paper elevation={0} sx={{ p: 2, borderRadius: 2, border: "1px solid #e9ecf2", maxWidth: 720 }}>
            <Stack spacing={2}>
                <Typography sx={{ fontSize: 24, fontWeight: 700 }}>Profil</Typography>
                <Stack direction="row" spacing={2} alignItems="center">
                    <Avatar
                        src={imagePreviewUrl || (profile?.image ? `${api.defaults.baseURL}${profile.image}` : undefined)}
